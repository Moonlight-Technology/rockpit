...
-- CreateIndex
CREATE INDEX "BoardColumn_boardId_position_idx" ON "public"."BoardColumn"("boardId", "position");

-- CreateIndex
CREATE INDEX "Task_boardId_columnId_position_idx" ON "public"."Task"("boardId", "columnId", "position");
